...
import { Plus, Search, Filter, User, Mail, Phone, Clock } from 'lucide-react';
...
const StaffManager: React.FC = () => {
  ...
  const getRoleColor = (role: string) => {
    switch (role) {
      ...
      case 'Coordinator': return 'bg-amber-100 text-amber-800 dark:bg-amber-900/20 dark:text-amber-400';
  ...
  return (
    <div className="space-y-6">
          ...
          >
            ...
            <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
              <div className="flex space-x-2">
                ...
                <button className="flex-1 bg-gray-300 hover:bg-gray-400 dark:bg-gray-600 dark:hover:bg-gray-500 text-gray-700 dark:text-gray-300 py-2 px-3 rounded-lg text-sm transition-colors">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Staff Statistics</h3>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">On Duty Now</div>
          </div>
          <div className="text-center">
